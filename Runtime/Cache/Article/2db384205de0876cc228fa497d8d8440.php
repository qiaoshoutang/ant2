<?php if (!defined('THINK_PATH')) exit();?><h3><?php echo ($name); ?>新闻</h3>
    ...
    <div class="g-main-content m-form-horizontal">
        ...
        <div class="formitm">
            ...
            <div class="ipt">
                <input name="author" type="text"  class="form-element u-width-full  " id="author" value="<?php echo ($info["author"]); ?>" maxlength="50"   >
                <p class="help-block">请不要填写特殊字符</p>
            </div>
        </div>
