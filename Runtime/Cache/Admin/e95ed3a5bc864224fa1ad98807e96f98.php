...
<div class="m-table-mobile"><table id="table" class="m-table "><thead><tr><th width="80">编号</th><th>排序</th><th>名称</th><th>封面图</th><th>地点</th><th>活动时间</th><th>状态</th><th>添加时间</th><th width="130">操作</th></tr></thead><tbody><?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
