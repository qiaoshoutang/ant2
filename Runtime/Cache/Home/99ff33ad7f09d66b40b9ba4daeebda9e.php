<?php if (!defined('THINK_PATH')) exit();?><div class="nav-header">
    <!--蚂蚁logo-->
    <div class="My-logo">
...
=======
<!--                     <div class="sub-page-nav"  onclick='window.location.href="/short"'>快讯</div>
                    <div class="sub-page-nav padd-T" onclick='window.location.href="/news"'>新闻动态</div> -->
                    <div class="sub-page-nav" >快讯</div>
                    <div class="sub-page-nav padd-T nav_last">新闻动态</div>
>>>>>>> origin/master
                </div>
            </div>
        </li>
...
<!--                     <div class="sub-page-nav" onclick='window.location.href="/antmap/1"'>行情</div>
                    ...
                    <div class="sub-page-nav" >行情</div>
                    <div class="sub-page-nav" >交易所</div>
                    <div class="sub-page-nav">TOP200</div>
                    <div class="sub-page-nav" >钱包</div>
                    <div class="sub-page-nav" >矿池</div>
                    <div class="sub-page-nav">媒体</div>
                    <div class="sub-page-nav padd-T nav_last">技术服务</div>
                </div>
            </div>
        </li>
        <li>
...
=======
<!--                     <div class="sub-page-nav" onclick='window.location.href="/activity/1"'>报名中</div>
                    <div class="sub-page-nav padd-T" onclick='window.location.href="/activity/2"'>已结束</div> -->
                    <div class="sub-page-nav" >报名中</div>
                    <div class="sub-page-nav padd-T nav_last">已结束</div>
>>>>>>> origin/master
                </div>
            </div>
        </li>
        <li>
            <div class="sub-page">
                ...
                <div class="sub-page-navH">
                    ...
                    <div class="sub-page-nav padd-T nav_last"  onclick='window.location.href="/contactus"'>联系我们</div>
                </div>
            </div>
        </li>
    </ul>
